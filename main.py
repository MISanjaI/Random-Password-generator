...
class DeleteAccount(Screen):
    ...
    def delete_pass(self):
        ...
        self.success = MDDialog(title='Success!', text='This user has been deleted from the database',
...
class PasswordScreen(Screen):
    ...
    def buildPassword(self):
        ...
        self.digit = MDDialog(title='Error Encountered', text='Fill all fields and only use digits', buttons=[close],
                              auto_dismiss=False)
        ...
        self.fill = MDDialog(title='Filling in the gaps',
                             text='Adding in additional random characters to satisfy length', buttons=[close],
                             auto_dismiss=False)
        ...
        self.length = MDDialog(title='Error Encountered', text='Please ensure entered char total less than length',
                               buttons=[close], auto_dismiss=False)
    ...
    def save(self):
        ...
        if password == '':
            ...
            self.gen = MDDialog(title='Error Encountered', text='Remember to click generate!', buttons=[close],
                                auto_dismiss=False)
            self.gen.open()
        else:
